...
export const reviewRatingUpdate = 
    (reviewRating: string) => (dispatch: any) => {
        dispatch({
            payload: {
                reviewRating
            },
...
export const reviewTitleUpdate = 
    (reviewTitle: string) => (dispatch: any) => {
        dispatch({
            payload: {
                reviewTitle
            },
...
export const reviewBodyUpdate = 
    (reviewBody: string) => (dispatch: any) => {
        dispatch({
            payload: {
                reviewBody
            },
...
export const reviewFirstNameUpdate = 
    (reviewFirstName: string) => (dispatch: any) => {
        dispatch({
            payload: {
                reviewFirstName
            },
...
export const reviewLastNameUpdate = 
    (reviewLastName: string) => (dispatch: any) => {
        dispatch({
            payload: {
                reviewLastName
            },
    ...
    export const singleReviewIsOpen = 
        (isOpen: boolean) => (dispatch: any) => {
        dispatch({
                payload: {
                    isOpen
                },
