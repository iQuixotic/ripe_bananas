...
export const loginPasswordUpdate = 
    (loginPassword: string) => (dispatch: any) => {
        dispatch({
            payload: {
                loginPassword
            },
...
export const signupEmailUpdate = 
    (signupEmail: string) => (dispatch: any) => {
        dispatch({
            payload: {
                signupEmail
            },
...
export const signupPasswordUpdate = 
    (signupPassword: string) => (dispatch: any) => {
        dispatch({
            payload: {
                signupPassword
            },
...
export const signupConfirmPassword = 
    (confirmPassword: string) => (dispatch: any) => {
        dispatch({
            payload: {
                confirmPassword
            },
...
export const signupFirstnameUpdate = 
    (firstname: string) => (dispatch: any) => {
        dispatch({
            payload: {
                firstname
            },
...
export const signupLastnameUpdate = 
    (lastname: string) => (dispatch: any) => {
        dispatch({
            payload: {
                lastname
            },
